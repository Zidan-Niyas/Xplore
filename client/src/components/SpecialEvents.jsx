...
import Motoshow from '../assets/images/Proshow/Motoshow.webp';
import Pro_show from '../assets/images/Proshow/Pro_show.webp';
import { VelocityScrollText } from './ui/scroll-based-text';
function SpecialEvents() {
  return (
    <>
      ...
      <section className="gap-8 h-fit dark:bg-black flex flex-col gap-32 pt-20 justify-center items-center pb-32">
        
      <figure className="w-[90%] md:w-[50%] group hover:p-4 transition-all duration-200 rounded-xl">
            <h2 className="text-6xl md:text-8xl font-extrabold mb-6 text-center relative font-road-rage-regular">
                Moto Show
            </h2>
            <div className="w-64 h-1 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 mx-auto mb-20"></div>
        ...
        <figure className="w-[90%] md:w-[50%] group hover:p-4 transition-all duration-200 rounded-xl">
            <h2 className="text-6xl md:text-8xl font-extrabold mb-6 text-center relative font-roadRage">
                Pro Show
            </h2>
            <div className="w-64 h-1 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 mx-auto mb-20"></div>
